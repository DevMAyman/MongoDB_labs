...
// x.forEach(doc => printjson(doc.pretty())) 
...
{$group:{
    ...
    {
    $sort: {
         totalCount: -1 // Sort in ascending order, use -1 for descending order
      }
  },
    {
      $skip: 2 // get third author
   },
   {
      $limit: 5 // get from third author to eighth
   }
])
